...
/**
 * Validates message content to prevent malicious payloads
 * Checks for null bytes, RTL overrides, and structure validity
 * @throws Error if message content is invalid or contains attack vectors
 */
export declare const validateMessageContent: (content: AnyMessageContent) => boolean
