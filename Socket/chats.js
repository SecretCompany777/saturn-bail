...
const makeChatsSocket = (config) => {
    ...
    const guns = socket_1.makeSocket(config)
    const { ev, ws, authState, generateMessageTag, sendNode, query, signalRepository, onUnexpectedError, groupFetchAllParticipating } = guns
	...
	const getLidUser = async (jid) => {
        ...
        const result = await guns.executeUSyncQuery(usyncQuery)
